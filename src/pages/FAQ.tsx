...
const FAQ: React.FC = () => {
  const questions = [
    ...
    },
    {
      ...
      answer:
        "Crowndfunding accepte une variété de projets dans les domaines de l'éducation, l'environnement, la santé, les technologies, les arts, l'entrepreneuriat social et plus encore. Les projets doivent respecter nos conditions d'utilisation et ne pas être illégaux, frauduleux ou nuisibles. Nous encourageons particulièrement les initiatives à impact social positif.",
    },
    {
      id: "frais-campagnes",
      question: "Quels frais sont appliqués aux campagnes ?",
      answer:
        "Crowndfunding prélève des frais de 5% sur les fonds collectés pour les campagnes réussies, plus des frais de traitement des paiements de 3%. Ces frais nous permettent de maintenir et d'améliorer la plateforme, tout en offrant un support de qualité aux créateurs de campagnes.",
    },
    {
      id: "objectif-non-atteint",
    ...
    },
    {
      ...
      answer:
        "Pour toute question, vous pouvez nous contacter via notre formulaire de contact accessible depuis la page 'Contact'. Notre équipe s'efforcera de vous répondre dans un délai de 48 heures ouvrables. Pour les questions urgentes, vous pouvez également nous contacter par email à support@Crowndfunding.com.",
    },
    {
      id: "remboursement-contribution",
